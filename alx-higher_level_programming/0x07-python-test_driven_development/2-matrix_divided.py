...
def matrix_divided(matrix, div):
    ...
    Args:
        matrix (list): A 2-dimensional list of ints or floats.
        div (int/float): The divisor.

    Raises:
        TypeError: Matrix contains element not int or float
        TypeError: Matrix row contains different sizes
        TypeError: ``div`` not an int or float
